...
class ExecutionCostModel:
    ...
    def calculate_fill(
        ...
        # Enforce liquidity participation limit (e.g. max 5% of daily volume)
        ...
        # Slippage dollar cost
        slippage_cost = abs(fill_price - mid_price) * executed_qty

        # Broker commission
        if asset_class == AssetClass.CRYPTO:
            commission = max((mid_price * executed_qty) * 0.0010, 0.50)  # 10 bps taker fee
        else:
